            ...
            [
                ...
                'endpoints' => [
                    [
                        ...
                        'description' => 'Get all customers for the authenticated user\'s store. Supports pagination, search, filtering, and sorting.',
                        'auth' => 'Bearer Token (Required)',
                        'parameters' => [
                            'optional' => [
                                ...
                                'search' => 'string - Search by name, email, or phone_number (partial match)',
                    ...
                    'item' => [
                        [
                            ...
                            'request' => [
                                ...
                                'url' => [
                                    'raw' => '{{base_url}}/customers?paginated=true&per_page=15&page=1&search=&sort_by=created_at&sort_order=desc',
                                    'host' => ['{{base_url}}'],
                                    'path' => ['customers'],
                                    'query' => [
                                        [
                                        ...
                                        [
                                            'key' => 'phone_number',
                                            'value' => '',
                                            'description' => 'Filter by exact phone_number',
                                            'disabled' => true,
                                        ],
                                        [
                                            'key' => 'created_from',
                                        ...
                                        [
                                            'key' => 'sort_by',
                                            'value' => 'created_at',
                                            'description' => 'Sort field: name, email, phone_number, created_at, updated_at',
                                        ],
                                        [
                                            'key' => 'sort_order',
                                            'value' => 'desc',
