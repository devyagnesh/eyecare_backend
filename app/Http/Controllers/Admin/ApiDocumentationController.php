            ...
            [
                ...
                'endpoints' => [
                    ...
                    [
                        ...
                        'description' => 'Resend email verification notification to the authenticated user. Only works if email is not already verified. Rate limited to 3 requests per 15 minutes per email.',
                        'auth' => 'Bearer Token (Required)',
                        'parameters' => [],
                        'request_payload' => null,
                        'response' => [
                        ...
                        'error_response_2' => [
                            ...
                            'description' => 'Rate limit exceeded: Maximum 3 requests per 15 minutes.',
                        ],
                    ],
                    [
                        'method' => 'POST',
                        ...
                        'description' => 'Request a password reset link. Sends an email with a password reset link to the provided email address. Rate limited to 3 requests per 15 minutes per email. Does not reveal if the email exists (security feature).',
                        'auth' => 'None',
                        'parameters' => [
                            'required' => [
                                'email' => 'string - User email address',
                        ...
                        'error_response_3' => [
                            ...
                            'description' => 'Rate limit exceeded: Maximum 3 requests per 15 minutes per email.',
                        ],
                    ],
                    [
                        'method' => 'POST',
                        ...
                        'name' => 'Reset Password',
                        'description' => 'Reset user password using the token from the password reset email. Token expires after 60 minutes. All user sessions are invalidated after password reset.',
                        'auth' => 'None',
                        'parameters' => [
                            'required' => [
                                'email' => 'string - User email address',
            ...
            [
                ...
                'endpoints' => [
                    ...
                    [
                        ...
                        'url' => $baseUrl . '/stores',
                        'name' => 'Create Store',
                        'description' => 'Create a new store for the authenticated user. Requires email verification. Each user can create only one store. Email and phone number must be unique across all stores. Phone number must be valid (7-15 digits, optionally starting with +). If a store already exists, use the update endpoint instead.',
                        ...
                        'parameters' => [
                            'required' => [
                                ...
                                'phone_number' => 'string - Store phone number (must be unique, 7-15 digits, optionally starting with +)',
                    ...
                    [
                        ...
                        'url' => $baseUrl . '/stores',
                        'name' => 'Update Store',
                        'description' => 'Update the authenticated user\'s existing store. Can update any or all fields including logo. Old logo is automatically deleted when a new one is uploaded. Email and phone number must be unique across all stores (excluding the current store). Phone number must be valid (7-15 digits, optionally starting with +).',
                        'auth' => 'Bearer Token (Required)',
                        'parameters' => [
                            'optional' => [
                                'name' => 'string - Store name (max 255 characters)',
            ...
            [
                ...
                'endpoints' => [
                    ...
                    [
                        ...
                        'description' => 'Create a new customer for the authenticated user\'s store. Store ID is automatically set from the authenticated user\'s store. Phone number and email must be unique within the store (same customer can exist in different stores with same phone/email). Phone number must be valid (7-15 digits, optionally starting with +). Email is optional.',
                        'auth' => 'Bearer Token (Required)',
                        'parameters' => [
                            'required' => [
                                'name' => 'string - Customer name (max 255 characters)',
                                'phone_number' => 'string - Customer phone number (must be unique within the store, 7-15 digits, optionally starting with +, max 20 characters)',
                            ],
                            'optional' => [
                                'email' => 'string - Customer email address (must be unique within the store if provided, max 255 characters)',
                    ...
                    [
                        ...
                        'description' => 'Update an existing customer. Only customers belonging to the authenticated user\'s store can be updated. Phone number and email must be unique within the store (same customer can exist in different stores with same phone/email). Phone number must be valid (7-15 digits, optionally starting with +).',
                        'auth' => 'Bearer Token (Required)',
                        'parameters' => [
                            'required' => [
                                'id' => 'integer - Customer ID (route parameter)',
            ...
            [
                ...
                'endpoints' => [
                    ...
                    [
                        ...
                        'description' => 'Create a new eye examination record for a customer. Store ID is automatically set from the authenticated user\'s store. A PDF report is automatically generated and includes store details, doctor information, patient information, and all examination data. Both authenticated PDF download URL and public PDF download URL (signed URL, no authentication required) are returned in the response. Required fields: customer_id, store_id, exam_date, od_sphere, od_cylinder, os_sphere, os_cylinder. Axis is required only if corresponding cylinder is not 0.00. PD near must be less than PD distance if both provided. Add power must be 0.00 or positive (max 3.50).',
                        'auth' => 'Bearer Token (Required)',
                        'parameters' => [
                            'required' => [
                                'customer_id' => 'integer - Customer ID (must belong to your store)',
                                'store_id' => 'integer - Store ID (must match authenticated user\'s store)',
                                'exam_date' => 'date - Date of examination (YYYY-MM-DD, cannot be in the future)',
                                'od_sphere' => 'numeric - Right eye spherical power (-20.00 to +20.00)',
                                'od_cylinder' => 'numeric - Right eye cylindrical power (-20.00 to +20.00)',
                                'os_sphere' => 'numeric - Left eye spherical power (-20.00 to +20.00)',
                                'os_cylinder' => 'numeric - Left eye cylindrical power (-20.00 to +20.00)',
                            ],
                            'optional' => [
                                'old_rx_date' => 'date - Date of previous prescription (YYYY-MM-DD, must be before exam_date)',
                                'od_va_unaided' => 'string - Right eye unaided visual acuity (max 20 characters, e.g., "20/20")',
                                'os_va_unaided' => 'string - Left eye unaided visual acuity (max 20 characters, e.g., "20/20")',
                                'od_axis' => 'integer - Right eye axis (0-180 degrees, required if od_cylinder is not 0.00)',
                                'os_axis' => 'integer - Left eye axis (0-180 degrees, required if os_cylinder is not 0.00)',
                                'add_power' => 'numeric - Reading addition power (0.00 to 3.50, must be 0.00 or positive)',
                                'pd_distance' => 'numeric - Distance pupillary distance in mm (40-80 mm)',
                                'pd_near' => 'numeric - Near pupillary distance in mm (40-80 mm, must be less than pd_distance)',
                                'od_bcva' => 'string - Right eye best corrected visual acuity (max 20 characters, e.g., "20/20")',
                                'os_bcva' => 'string - Left eye best corrected visual acuity (max 20 characters, e.g., "20/20")',
                                'iop_od' => 'integer - Right eye intraocular pressure in mmHg (5-60)',
                                'iop_os' => 'integer - Left eye intraocular pressure in mmHg (5-60)',
                                ...
                                'next_recall_date' => 'date - Recommended date for next check-up (YYYY-MM-DD, must be after exam_date)',
                            ],
                        ],
                        'request_payload' => [
                            'customer_id' => 1,
                    ...
                    [
                        ...
                        'description' => 'Update an existing eye examination. Only examinations belonging to the authenticated user\'s store can be updated. The response includes both authenticated PDF download URL and public PDF download URL. Validation rules: Axis is required only if corresponding cylinder is not 0.00. PD near must be less than PD distance if both provided. Add power must be 0.00 or positive (max 3.50).',
                        'auth' => 'Bearer Token (Required)',
                        'parameters' => [
                            'required' => [
                                'id' => 'integer - Eye Examination ID (route parameter)',
