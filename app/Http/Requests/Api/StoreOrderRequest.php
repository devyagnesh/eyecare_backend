...
class StoreOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'frame_photos' => 'nullable|array|max:10',
            'frame_photos.*' => 'image|mimes:jpeg,jpg,png,webp|max:5120',
    ...
    public function messages(): array
    {
        return [
            ...
            'frame_photos.array' => 'Frame photos must be an array.',
            'frame_photos.max' => 'Maximum 10 frame photos allowed.',
            'frame_photos.*.image' => 'Each frame photo must be an image file.',
            'frame_photos.*.mimes' => 'Each frame photo must be a JPEG, PNG, or WebP image.',
            'frame_photos.*.max' => 'Each frame photo must not exceed 5MB.',
