    ...
    <div class="main-sidebar" id="sidebar-scroll">
        ...
        <nav class="main-menu-container nav nav-pills flex-column sub-open">
            ...
            <ul class="main-menu">
                ...
                <!-- Start::slide -->
                <li class="slide">
                    <a href="{{ route('admin.terms.index') }}" class="side-menu__item {{ request()->routeIs('admin.terms.*') ? 'active' : '' }}">
                ...
                <!-- Start::slide -->
                <li class="slide">
                    <a href="{{ route('scramble.docs.ui') }}" class="side-menu__item {{ request()->routeIs('scramble.docs.*') || request()->is('docs/api*') ? 'active' : '' }}" target="_blank">
