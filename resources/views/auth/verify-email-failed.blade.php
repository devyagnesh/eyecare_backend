...
<head>
    ...
    <title>Email Verification Failed | Admin Panel</title>
                ...
                <div class="card custom-card my-4 border z-3 position-relative">
                    <div class="card-body p-0">
                        <div class="p-5 text-center">
                            <div class="mb-4">
                                <i class="ri-close-circle-line text-danger" style="font-size: 64px;"></i>
                            </div>
                            <p class="h4 fw-semibold mb-2">Email Verification Failed</p>
