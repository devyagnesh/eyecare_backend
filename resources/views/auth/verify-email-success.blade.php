...
<head>
    ...
    <title>Email Verified - Eyecare Management System</title>
                ...
                <div class="card custom-card shadow-lg">
                    <div class="card-body p-5">
                        <div class="text-center mb-4">
                            <div class="avatar avatar-lg avatar-rounded bg-success-transparent mx-auto mb-3" style="width: 80px; height: 80px; display: flex; align-items: center; justify-content: center;">
                                <i class="ri-checkbox-circle-fill fs-48 text-success"></i>
                            </div>
                        ...
                        <div class="text-center mt-4">
                            <p class="text-muted mb-0" style="font-size: 13px;">
                                <i class="ri-shield-check-line me-1"></i> Your account is secure and ready to use
                            </p>
                        </div>
                    </div>
                </div>
