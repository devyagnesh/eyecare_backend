...
<head>
    ...
    <title>Email Already Verified | Admin Panel</title>
                ...
                <div class="card custom-card my-4 border z-3 position-relative">
                    <div class="card-body p-0">
                        <div class="p-5 text-center">
                            <div class="mb-4">
                                <i class="ri-information-line text-info" style="font-size: 64px;"></i>
                            </div>
                            <p class="h4 fw-semibold mb-2">Email Already Verified</p>
                            <p class="text-muted mb-4">Your email has already been verified. You can sign in to your account.</p>
                            <div class="d-grid">
