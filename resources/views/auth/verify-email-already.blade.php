...
<head>
    ...
    <title>Already Verified - Eyecare Management System</title>
                ...
                <div class="card custom-card shadow-lg">
                    <div class="card-body p-5">
                        <div class="text-center mb-4">
                            <div class="avatar avatar-lg avatar-rounded bg-info-transparent mx-auto mb-3" style="width: 80px; height: 80px; display: flex; align-items: center; justify-content: center;">
                                <i class="ri-information-line fs-48 text-info"></i>
                            </div>
                            ...
                            <div class="alert alert-success border-success mb-4 text-start" role="alert">
                                ...
                                <p class="mb-0" style="font-size: 14px;">Your account is verified and ready to use. Log in to access all features of the Eyecare Management System.</p>
                            </div>
                        </div>
                        <div class="d-grid">
