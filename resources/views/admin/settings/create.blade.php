...
<div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
    <div>
        <h1 class="page-title fw-medium fs-18 mb-2">Create Setting</h1>
        <div>
            <nav>
...
<div class="row">
    <div class="col-xl-12">
        <div class="card custom-card">
            ...
            <div class="card-body">
            <form action="{{ route('admin.settings.store') }}" method="POST" data-ajax="true" data-table-id="#settings-table">
                @csrf
                ...
                <div class="d-flex gap-2">
                    <x-button type="submit" variant="primary" wave>
                        <i class="ri-save-line"></i> Create Setting
                    </x-button>
